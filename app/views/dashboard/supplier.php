    ...
    <div class="container-fluid px-4">
      ...
      <div class="card mb-4">
        ...
        <div class="card-header">
          ...
          <div class="card-body">
            <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#tambahSupplier">
              Tambah Supplier
            </button>
              <table id="datatablesSimple">
                ...
                <tbody>
                  <?php $nomor = 1; foreach( $data['suppliers'] as $supplier ) : ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= BASEURL ?>/dashboard/supplier" method="post" enctype="multipart/form-data">
